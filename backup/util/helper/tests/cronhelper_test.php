...
class backup_cron_helper_testcase extends advanced_testcase {
    ...
    public function test_get_courses() {
        ...
        // First should be course 2, it is the most recently modified without a backup.
        $this->assertEquals($course2->id, $coursearray[0]);

        // Second should be course 1, it is the oldest modified without a backup.
        $this->assertEquals($course1->id, $coursearray[1]);
