...
$string['autocompletepagination'] = 'Autocomplete pagination';
$string['autocompletepagination_desc'] = 'Set the pagination size when autocomplete results is showing';
$string['autocompletesearchresult'] = '<a href="{$a->link}">See all search results</a>';
$string['back'] = 'Back';
...
$string['noresultsfound'] = 'No results found for {$a}';
