...
$string['manualenrols'] = 'Keep manual enrolments of role';
$string['manualenrols_help'] = 'Select which roles in the source course that you want to keep enrolments for in the new course.';
...
$string['userdata_help'] = 'When enabled user data in the source course will be copied into the new course.';
