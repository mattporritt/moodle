...
$string['asyncmessagesubjectdefault'] = 'Moodle {operation} completed sucessfully';
...
$string['asyncrestorecompletedetail'] = 'The restore process has completed sucessfully completed. Clicking continue will take you to the <a href="{$a}">restored item.</a>';
...
$string['asyncrestorerocessing'] = 'The restore is in progress';
