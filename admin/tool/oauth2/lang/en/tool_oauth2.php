...
$string['issuerrequireconfirmation_desc'] = 'Disabling email verification can be a security issue.';
$string['issuerrequireconfirmation_warn'] = 'Disabling email verification can be a security issue. As it potentially allows users to authenticate as another in the right circumstances.';
