...
class user_setup_factor extends \core\event\base {
     ...
     *
     * @return user_passed_mfa|user_setup_factor the user_passed_mfa event
     *
     * @throws \coding_exception
     */
    public static function user_setup_factor_event(stdClass $user, $factorname): user_passed_mfa|user_setup_factor {
