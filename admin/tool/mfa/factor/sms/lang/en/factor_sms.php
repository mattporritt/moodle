...
$string['logindesc'] = 'We\'ve just sent a 6-digit code via SMS to your phone number: {$a}';
$string['loginoption'] = 'Have a code sent to you via SMS';
$string['loginskip'] = "I didn't receive a code";
$string['loginsubmit'] = 'Verify code';
$string['logintitle'] = "Verify it's you by SMS";
