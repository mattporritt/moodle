...
$string['email:loginlink'] = 'Or follow {$a} on the same device you\'re trying to log in from.';
$string['email:message'] = 'Here\'s your verfication code for {$a->sitename} ({$a->siteurl}).';
$string['email:originatingip'] = 'This login request was made from \'{$a}\'';
$string['email:revokelink'] = 'If this wasn\'t you, stop this login attempt by following {$a}.';
