...
$string['action:generate_image:model_help'] = 'The model used to generate images from user prompts. <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/models-supported.html" target="_blank">Supported foundation models in Amazon Bedrock</a>';
$string['action:generate_text:model'] = 'AI model';
$string['action:generate_text:model_help'] = 'The model used to generate the text response. <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/models-supported.html" target="_blank">Supported foundation models in Amazon Bedrock</a>';
...
$string['apisecret_help'] = 'Generate a secret using Identity and Access Management (IAM) in the Amazon Web Services (AWS) console or using the AWS  Command Line Interface (CLI).';
...
$string['none'] = 'None';
$string['pluginname'] = 'Amazon Bedrock provider';
$string['privacy:metadata'] = 'The Amazon Bedrock provider plugin does not store any personal data.';
$string['privacy:metadata:aiprovider_awsbedrock:externalpurpose'] = 'This information is sent to Amazon Web Services (AWS) in order for a response to be generated. Your AWS account settings may change how AWS stores and retains this data. No user data is explicitly sent to AWS or stored in Moodle LMS by this plugin.';
...
$string['settings_cfg_scale'] = 'Classifier-Free Guidance (CFG) scale';
...
$string['settings_help'] = 'Adjust the settings below to customise how requests are sent to Amazon Bedrock.';
$string['settings_max_tokens'] = 'Max tokens';
$string['settings_max_tokens_help'] = 'The maximum number of tokens used to generate content. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
...
$string['settings_seed_help'] = 'Ensures consistent results when using the same seed and parameters. While results are usually repeatable, total consistency isn\'t 100% guaranteed. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
