...
$string['settings_max_tokens_help'] = 'The maximum number of tokens that can be generated in the chat completion. The total length of input tokens and generated tokens is limited by the model\'s context length. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
...
$string['settings_temperature_bounds'] = 'temperature';
$string['settings_temperature_bounds_help'] = 'What sampling temperature to use. Higher values like 0.8 will make the output more random, while lower values like 0.2 will make it more focused and deterministic. We generally recommend altering this or top_p but not both. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
...
$string['settings_top_logprobs_bounds'] = 'top_logprobs';
$string['settings_top_logprobs_bounds_help'] = 'The number of most likely tokens to return at each token position, each with an associated log probability. logprobs must be set to true if this parameter is used. Min: {$a->min}, Max: {$a->max}.';
...
$string['settings_top_p_bounds_help'] = 'An alternative to sampling with temperature, called nucleus sampling, where the model considers the results of the tokens with top_p probability mass. So 0.1 means only the tokens comprising the top 10% probability mass are considered. We generally recommend altering this or temperature but not both. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
