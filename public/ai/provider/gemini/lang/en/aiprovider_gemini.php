...
$string['settings_max_output_tokens_help'] = 'The maximum number of tokens used in the generated text. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
...
$string['settings_temperature_help'] = 'Temperature influences whether the output is more random and creative or more predictable. Increasing the temperature will make the model answer more creatively. This setting works alongside other options like top p and top k to generate the output. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
$string['settings_top_k'] = 'Top k';
$string['settings_top_k_help'] = 'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
$string['settings_top_p'] = 'Top p';
$string['settings_top_p_help'] = 'Top p (nucleus sampling) determines how many possible words to consider. A high value (e.g. 0.9) means the model looks at more words, which makes the generated text more diverse. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
