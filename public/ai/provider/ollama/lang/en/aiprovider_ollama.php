...
$string['settings_mirostat_help'] = 'Mirostat is a neural text decoding algorithm for controlling perplexity. 0 = disabled, 1 = Mirostat, 2 = Mirostat 2.0. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
$string['settings_seed'] = 'seed';
$string['settings_seed_help'] = 'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt. Default: {$a->default}.';
$string['settings_temperature'] = 'temperature';
$string['settings_temperature_help'] = 'Temperature influences whether the output is more random and creative or more predictable. Increasing the temperature will make the model answer more creatively. Default: {$a->default}.';
$string['settings_top_k'] = 'top_k';
$string['settings_top_k_help'] = 'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative. Default: {$a->default}.';
$string['settings_top_p'] = 'top_p';
$string['settings_top_p_help'] = 'Works together with top-k. A higher value (e.g. 0.95) will lead to more diverse text, while a lower value (e.g. 0.5) will generate more focused and conservative text. Min: {$a->min}, Max: {$a->max}, Default: {$a->default}.';
