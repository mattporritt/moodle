...
/**
 * Process image description requests with Ollama.
 *
...
class process_describe_image extends abstract_processor {
    ...
    protected function create_request_object(string $userid): RequestInterface {
        ...
        $requestobj = (object) [
            ...
            'stream' => false,
            'prompt' => $this->action->get_prompt(),
            'images' => [base64_encode($image->get_content())],
            'user' => $userid,
            'options' => (object) [],
        ];
    ...
    protected function handle_api_success(ResponseInterface $response): array {
        ...
        $generatedcontent = $bodyobj->response ?? null;
        ...
        return [
            ...
            'finishreason' => $bodyobj->done_reason ?? null,
            'prompttokens' => $bodyobj->prompt_eval_count ?? null,
            'completiontokens' => $bodyobj->eval_count ?? null,
