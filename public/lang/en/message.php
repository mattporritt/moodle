...
$string['messaginglifetime'] = 'Message lifetime';
$string['messaginglifetime_help'] = 'Messages older than this will be automatically deleted, but only once they have been read by all recipients in the conversation. Unread messages are kept regardless of age. The default of \'Never\' keeps all messages indefinitely.';
...
$string['usercantbemessagedbulk'] = 'You can\'t message the following users due to their message preferences. Try adding them as a contact.<br>{$a}';
