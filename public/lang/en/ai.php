...
$string['settings_rangeerror'] = 'Value must be between {$a->min} and {$a->max} for this model.';
$string['settings_rangeerror_max'] = 'Value must be {$a->max} or less for this model.';
$string['settings_rangeerror_min'] = 'Value must be {$a->min} or more for this model.';
