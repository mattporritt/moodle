...
$string['imageaccessnote'] = 'This image is served from its current location in the site. If it does not display, you may not have permission to view it there.';
...
$string['privacy:metadata:ai_action_generate_image:contenthash'] = 'The content hash of the generated image file, recorded at generation time.';
$string['privacy:metadata:ai_action_generate_image:localpathnamehash'] = 'The path name hash of the durable local copy of the generated image, once correlated with the file a placement saved permanently.';
