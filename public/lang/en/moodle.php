...
$string['loginkeepmeloggedin'] = 'Keep me logged in';
...
$string['privacy:metadata:auth_remember_me'] = 'Remember-me tokens for the keep-me-logged-in feature.';
$string['privacy:metadata:auth_remember_me:expiry'] = 'The time at which this token expires.';
$string['privacy:metadata:auth_remember_me:lastused'] = 'The time this token was last used.';
$string['privacy:metadata:auth_remember_me:selector'] = 'The selector used to look up the token.';
$string['privacy:metadata:auth_remember_me:timecreated'] = 'The time this token was created.';
$string['privacy:metadata:auth_remember_me:token'] = 'The SHA-256 hash of the token validator.';
$string['privacy:metadata:auth_remember_me:useragent'] = 'The user-agent string recorded when the token was created.';
$string['privacy:metadata:auth_remember_me:userid'] = 'The ID of the user this token belongs to.';
