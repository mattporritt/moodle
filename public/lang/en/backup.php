...
$string['backup_courses_in_categories_help'] = 'Select the course categories and subcategories to include in the backup. Leave blank to back up courses from all categories.';
