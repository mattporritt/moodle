...
$string['backup_courses_in_categories'] = 'Restrict backup to selected categories.';
$string['backup_courses_in_categories_help'] = 'Select the course categories to restrict automated backups to. Only courses that are direct members of the selected categories are backed up; courses in their subcategories are not included unless those subcategories are also selected. Leave blank to back up courses from all categories.';
