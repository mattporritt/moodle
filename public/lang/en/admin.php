...
$string['registrationreportingpausednewfieldsmessage'] = 'Your site ({$a->siteurl}) is registered, but automatic registration reporting is paused because new registration data needs to be confirmed. Visit the site registration page to review and confirm the new data.';
$string['registrationreportingpausedsubject'] = 'Site registration reporting has stopped';
$string['registrationreportingpausedtaskdisabled'] = 'Your site is registered, but automatic registration reporting is paused because the \'Site registration\' scheduled task is disabled.';
$string['registrationreportingpausedtaskdisabledmessage'] = 'Your site ({$a->siteurl}) is registered, but automatic registration reporting is paused because the \'Site registration\' scheduled task has been disabled. Re-enable the task to resume automatic reporting.';
$string['registrationtaskdisabled'] = 'Your site is registered, but the \'Site registration\' scheduled task is disabled, so registration updates are no longer being sent automatically. <a href="{$a}">Re-enable the task</a> to resume automatic reporting, or update your registration manually.';
...
$string['taskregistrationreportingcheck'] = 'Check site registration reporting status';
