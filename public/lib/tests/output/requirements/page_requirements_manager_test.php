...
final class page_requirements_manager_test extends \advanced_testcase {
     ...
     * single file to preload for those) and explicit inactive theme-variant duplicates of a
     * themable import are excluded, since preloading either would waste a request.
     */
    public function test_get_import_map_preloads_exactly_the_concrete_active_entries(): void {
        global $PAGE;
