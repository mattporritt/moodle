...
$string['managemisc'] = 'Manage miscellaneous settings';
$string['managemoodle'] = 'Manage TinyMCE Moodle plugins';
$string['managemoodle_desc'] = 'These settings allow you to enable, disable, and configure features of the TinyMCE editor provided by Moodle plugins, including TinyMCE Premium plugins. Any changes affect all TinyMCE editor instances sitewide.';
$string['managestandard'] = 'Manage TinyMCE standard features';
$string['managestandard_desc'] = 'These settings allow you to enable and disable various standard features of the TinyMCE editor. Any changes affect all TinyMCE editor instances sitewide.';
...
$string['standard_plugin_anchor'] = 'Anchor';
$string['standard_plugin_charmap'] = 'Character map';
$string['standard_plugin_code'] = 'Code';
$string['standard_plugin_codesample'] = 'Code sample';
$string['standard_plugin_directionality'] = 'Directionality';
$string['standard_plugin_emoticons'] = 'Emoticons';
$string['standard_plugin_fullscreen'] = 'Full screen';
$string['standard_plugin_help'] = 'Help';
$string['standard_plugin_insertdatetime'] = 'Insert date/time';
$string['standard_plugin_lists'] = 'Lists';
$string['standard_plugin_nonbreaking'] = 'Non-breaking space';
$string['standard_plugin_pagebreak'] = 'Page break';
$string['standard_plugin_quickbars'] = 'Quick bars';
$string['standard_plugin_save'] = 'Save';
$string['standard_plugin_searchreplace'] = 'Search and replace';
$string['standard_plugin_table'] = 'Table';
$string['standard_plugin_visualblocks'] = 'Visual blocks';
$string['standard_plugin_visualchars'] = 'Visual characters';
$string['standard_plugin_wordcount'] = 'Word count';
