...
$string['auth_ldapdescription'] = 'This method provides authentication against an external Lightweight Directory Access Protocol (LDAP) server. If the given username and password are valid, Moodle creates a new user entry in its database. This plugin can read user attributes from LDAP and prefill wanted fields in Moodle. For following logins only the username and password are checked.';
...
$string['auth_ldap_preventpassindb'] = 'Select yes to prevent passwords from being stored in Moodle\'s database.';
...
$string['auth_ntlmsso'] = 'New Technology LAN Manager (NTLM) SSO';
$string['auth_ntlmsso_enabled'] = 'Set to yes to attempt Single Sign-On (SSO) with the NTLM domain. Note that this requires additional setup on the server to work. For details, see the documentation <a href="https://docs.moodle.org/en/NTLM_authentication">NTLM authentication</a>.';
...
$string['auth_ntlmsso_ie_fastpath_key'] = 'Microsoft Internet Explorer (MS IE) fast path';
$string['auth_ntlmsso_ie_fastpath_yesform'] = 'Yes, all other browsers use standard login form';
$string['auth_ntlmsso_ie_fastpath_yesattempt'] = 'Yes, attempt NTLM with other browsers';
...
$string['ntlmsso_unknowntype'] = 'Unknown NTLM SSO type.';
...
$string['start_tls_key'] = 'Use Transport Layer Security (TLS)';
