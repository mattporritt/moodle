...
/**
 * Version details for the image alternative text report.
 *
...
// and the admin controls that switch them off. Everything else in this report works without it.
$plugin->dependencies = [
    'aiplacement_reportbuilder' => 2026080300,
];
