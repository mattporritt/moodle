 ...
 *
 * @package    core_admin
 * @copyright  2024 Sophie Lenz <sophie.lenz@htw-berlin.de>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class configmultiselect_autocomplete extends \core_admin\setting\setting\configmultiselect {
...
class_alias(configmultiselect_autocomplete::class, \admin_setting_configmultiselect_autocomplete::class);
