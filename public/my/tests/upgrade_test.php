...
final class upgrade_test extends \advanced_testcase {
    ...
    public function test_legacy_regions_are_migrated(): void {
        ...
        $this->assertSame(0, (int) $mainposition->gridcolumn);
        $this->assertSame(4, (int) $mainposition->gridcolumns);
        $this->assertSame(4, (int) $sideposition->gridcolumn);
        $this->assertSame(2, (int) $sideposition->gridcolumns);
        $this->assertSame(4, (int) $postsideposition->gridcolumn);
        $this->assertSame(2, (int) $postsideposition->gridcolumns);
        $this->assertTrue(
        ...
        $this->assertSame(3, (int) $mainposition->gridrows);
        $this->assertSame(3, (int) $sideposition->gridrows);
