...
$string['settings_stop_sequences'] = 'stopSequences';
...
$string['settings_temperature_help'] = 'Use a lower value to decrease randomness in responses. Default: 0.7, min: 0, max: 1.';
$string['settings_top_p'] = 'topP';
$string['settings_top_p_help'] = 'Use a lower value to ignore less probable options and decrease the diversity of responses. Default: 0.9, min: 0, max: 1.';
