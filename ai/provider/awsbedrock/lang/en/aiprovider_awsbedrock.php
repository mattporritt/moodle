...
$string['model_stability.stable-diffusion-xl-v1:0'] = 'Stability Stable Diffusion XL';
...
$string['settings_count_penalty_help'] = 'Use a higher value to lower the probability of generating new tokens that already appear at least once in the prompt or in the completion. Proportional to the number of appearances. Min {$a->min}, Max {$a->max}, Default {$a->default}.';
