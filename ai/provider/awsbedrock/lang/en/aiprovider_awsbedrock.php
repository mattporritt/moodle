...
$string['model_anthropic.claude-3-5-haiku-20241022-v1:0'] = 'Claude 3.5 Haiku';
...
$string['model_cohere.command-r-plus-v1:0'] = 'Cohere Command R+';
$string['model_cohere.command-r-v1:0'] = 'Cohere Command R';
...
$string['model_mistral.mistral-large-2402-v1:0'] = 'Mixtral Large Instruct';
$string['model_mistral.mistral-small-2402-v1:0'] = 'Mixtral Small Instruct';
...
$string['settings_count_penalty'] = 'Count penalty';
$string['settings_count_penalty_help'] = 'Use a higher value to lower the probability of generating new tokens that already appear at least once in the prompt or in the completion. Proportional to the number of appearances.';
$string['settings_cross_region_inference'] = 'Cross region inference';
$string['settings_cross_region_inference_help'] = 'The inference profile ID for this model.';
...
$string['settings_prompt_truncation'] = 'Prompt Truncation';
$string['settings_prompt_truncation_auto'] = 'Auto Preserve Order';
$string['settings_prompt_truncation_help'] = 'Truncate the prompt to the maximum token limit. This can help to ensure the prompt is not too long.';
$string['settings_prompt_truncation_off'] = 'Off';
...
$string['settings_seed_help'] = 'If specified, the backend will make a best effort to sample tokens deterministically, such that repeated requests with the same seed and parameters should return the same result. However, determinism cannot be totally guaranteed.';
