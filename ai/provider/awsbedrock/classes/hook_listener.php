    ...
    public static function set_model_form_definition_for_aiprovider_awsbedrock(after_ai_action_settings_form_hook $hook): void {
        ...
        if (isset($mform->_elementIndex['modeltemplate'])) {
            ...
            if ($model == 'custom') {
                ...
                $mform->addElement('html', get_string('settings_help', 'aiprovider_awsbedrock'));
                $mform->addElement(
                    'textarea',
                    'modelextraparams',
                ...
                $mform->addElement('static', 'modelextraparams_help', null, get_string('extraparams_help', 'aiprovider_awsbedrock'));
            } else {
