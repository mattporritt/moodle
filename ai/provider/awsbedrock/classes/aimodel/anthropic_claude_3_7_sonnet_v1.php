 ...
 */
class anthropic_claude_3_7_sonnet_v1 extends anthropic_claude_3_5_sonnet_v1 implements awsbedrock_base {
    ...
    public function add_model_settings(MoodleQuickForm $mform): void {
        ...
        $mform->setDefault('cross_region_inference', 'us.anthropic.claude-3-7-sonnet-20250219-v1:0');
