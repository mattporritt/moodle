...
/**
 * Meta Llama 3.2 11B Instruct  AI model.
 *
 * @package    aiprovider_awsbedrock
 * @copyright  2025 Matt Porritt <matt.porritt@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class meta_llama3_2_11b_instruct_v1 extends meta_llama3_8b_instruct_v1 implements awsbedrock_base {

    #[\Override]
    public function get_model_name(): string {
        return 'meta.llama3-2-11b-instruct-v1:0';
    }
    ...
    public function add_model_settings(MoodleQuickForm $mform): void {
        ...
        $mform->setDefault('cross_region_inference', 'us.meta.llama3-2-11b-instruct-v1:0');
