 ...
 */
class meta_llama3_2_1b_instruct_v1 extends meta_llama3_8b_instruct_v1 implements awsbedrock_base {
    ...
    public function add_model_settings(MoodleQuickForm $mform): void {
        ...
        $mform->setDefault('cross_region_inference', 'us.meta.llama3-2-1b-instruct-v1:0');
