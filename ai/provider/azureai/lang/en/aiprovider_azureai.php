...
$string['apiversion'] = 'Azure AI API version';
$string['apiversion_desc'] = 'Enter the version number for your Azure AI API.';
...
$string['endpoint_desc'] = 'Enter the endpoint URL for your Azure AI API.';
