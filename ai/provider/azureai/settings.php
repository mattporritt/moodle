...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configtext('aiprovider_azureai/endpoint',
    ...
    $settings->add(new admin_setting_configtext('aiprovider_azureai/globalratelimit',
            new lang_string('globalratelimit', 'aiprovider_azureai'),
            new lang_string('globalratelimit_desc', 'aiprovider_azureai'),
            100,
            PARAM_INT));
    new admin_settingdependency('aiprovider_azureai/globalratelimit', 'aiprovider_azureai/enableglobalratelimit', 'eq', 1);

    // Setting to enable/disable user rate limiting.
    $settings->add(new admin_setting_configcheckbox('aiprovider_azureai/enableuserratelimit',
    ...
    $settings->add(new admin_setting_configtext('aiprovider_azureai/userratelimit',
            new lang_string('userratelimit', 'aiprovider_azureai'),
            new lang_string('userratelimit_desc', 'aiprovider_azureai'),
            10,
            PARAM_INT));
    new admin_settingdependency('aiprovider_azureai/userratelimit', 'aiprovider_azureai/enableuserratelimit', 'eq', 1);
}
