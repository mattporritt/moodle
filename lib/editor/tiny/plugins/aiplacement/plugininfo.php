...
class plugininfo extends plugin implements plugin_with_buttons, plugin_with_menuitems, plugin_with_configuration {
    ...
    public static function get_plugin_configuration_for_context(
        ...
        foreach ($allowedtypes as $value) {
            switch ($value) {
                case \tiny_recordrtc\constants::TINYRECORDRTC_AUDIO_TYPE:
                    if (has_capability('tiny/recordrtc:recordaudio', $context)) {
                        $audioallowed = true;
                    }
                    break;
                case \tiny_recordrtc\constants::TINYRECORDRTC_VIDEO_TYPE:
                    if (has_capability('tiny/recordrtc:recordvideo', $context)) {
                        $videoallowed = true;
                    }
                    break;
                case \tiny_recordrtc\constants::TINYRECORDRTC_SCREEN_TYPE:
