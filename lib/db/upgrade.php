...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2024041200.00) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2024041200.01);
    }
    ...
    if ($oldversion < 2024062000.00) {
        ...
        $table->add_field('resolution', XMLDB_TYPE_CHAR, '21', null, XMLDB_NOTNULL, null, null);
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2024062000.01);
    }
