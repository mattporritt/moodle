...
class manager {
    ...
    #[\core\attribute\deprecated(
            ...
            since: '4.5',
            reason: 'Use destroy_all method instead',
    )]
    public static function kill_all_sessions(): void {
        \core\deprecation::emit_deprecation_if_present('core\session\manager::kill_all_sessions');
        self::destroy_all();
    }
    ...
    #[\core\attribute\deprecated(
            replacement: 'destroy',
            since: '4.5',
            reason: 'Use destroy method instead',
    )]
    public static function kill_session($sid): void {
        \core\deprecation::emit_deprecation_if_present('core\session\manager::kill_session');
        self::destroy($sid);
    }
     ...
     */
    #[\core\attribute\deprecated(
            replacement: 'destroy_for_auth_plugin',
            since: '4.5',
            reason: 'Use destroy_for_auth_plugin method instead',
    )]
    public static function kill_sessions_for_auth_plugin(string $pluginname): void {
        \core\deprecation::emit_deprecation_if_present('core\session\manager::kill_sessions_for_auth_plugin');
